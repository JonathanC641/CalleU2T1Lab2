...
public class RectangleRunner {
    public static void main(String[] args) {
        ...
        System.out.println("Rectangles 1 Area: " + rect1.calculateArea() + ", Box Volume:  " + rect1.calculateBoxVolume(rect1Height));
        System.out.print("Rectangles 1 Area: " + rect2.calculateArea() + ", Box Volume:  " + rect2.calculateBoxVolume(rect2Height));
